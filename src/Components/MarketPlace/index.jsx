    ...
    <div className="xl:container xl:mx-0 mx-8">
      <div className="flex flex-wrap text-center">
        {showback == true ?
          ...
          : null}
        <h2 className="text-3xl my-20 font-bold">{heading ? heading : 'Explore the marketplace'}</h2>
      </div>
      <div>
        <ul className="flex flex-wrap text-center">
          <li onClick={() => AddService(1, 'Graphics & Design')} className="mb-14 w-1/2 md:w-1/3  lg:w-1/4 xl:w-1/5 col-auto " >
            <a className="image"  >
              <img
                loading="lazy"
          ...
          <li onClick={() => AddService(2, 'Digital Marketing')} className="mb-14 w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/5 col-span-1">
            <a className="image" >
              <img
                loading="lazy"
                className="w-1/3 lg:w-1/4 xl:w-1/5 m-auto "
          ...
          <li onClick={() => AddService(3, 'Writing & Translation')} className="mb-14 w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/5">
            <a className="image" >
              <img
                loading="lazy"
                className="w-1/3 lg:w-1/4 xl:w-1/5 m-auto "
          ...
          <li onClick={() => AddService(4, 'ideo & Animation')} className="mb-14 w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/5">
            <a className="image" >
              <img
                loading="lazy"
                className="w-1/3 lg:w-1/4 xl:w-1/5 m-auto "
          ...
          <li onClick={() => AddService(5, 'Music & Audio')} className="mb-14 w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/5">
            <a className="image" >
              <img
                loading="lazy"
                className="w-1/3 lg:w-1/4 xl:w-1/5 m-auto "
          ...
          <li onClick={() => AddService(6, 'Programming & Tech')} className="mb-14 w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/5">
            <a className="image" >
              <img
                loading="lazy"
                className="w-1/3 lg:w-1/4 xl:w-1/5 m-auto "
          ...
          <li onClick={() => AddService(7, 'Business')} className="mb-14 w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/5">
            <a className="image" >
              <img
                loading="lazy"
                className="w-1/3 lg:w-1/4 xl:w-1/5 m-auto "
          ...
          <li onClick={() => AddService(8, 'Lifestyle')} className="mb-14 w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/5">
            <a className="image" >
              <img
                loading="lazy"
                className="w-1/3 lg:w-1/4 xl:w-1/5 m-auto "
          ...
          <li onClick={() => AddService(9, 'Data')} className="mb-14 w-1/2 md:w-1/3 md:mt-3  xl:mt-0  lg:w-1/4 xl:w-1/5">
            <a className="image" >
              <img
                loading="lazy"
